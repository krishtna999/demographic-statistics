...
.run(function($http,$rootScope)     //Scope of ng-app or Angular App
{
    if(sessionStorage.length > 0){      //if session storage exists 
        $rootScope.current_user = sessionStorage.current_user;
        $rootScope.authenticated = true;
    }else{                              //Otherwise its a Guest Session
        $rootScope.authenticated = false;
        $rootScope.current_user = 'Guest';
    }
    
    $rootScope.signout = function(){    //On Signout , convert to guest session
    ...
    function ($stateProvider, $urlRouterProvider,$rootScope) {
        ...
        $stateProvider
            .state('home', {
                ...
                controller: 'MainController'    //Belongs to MainController !!
            })
            .state('contact', {
                url: '/contact',
            ...
            .state('login',{
                ...
                caseInsensitiveMatch: true,
                controller: 'AuthController'    //Belongs to AuthController to authenticate
            })
            .state('register',{
                url: '/register',
